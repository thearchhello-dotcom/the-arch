...
export const products: Product[] = [
  ...
  { id: "next-black-trainers", name: "Black and White Touch Fastening Trainers", category: "Boys", retailer: "Next", price: 18.00, type: "foot" },
  { id: "next-ecru-fleece", name: "Multi Bright Ecru Zip Through Fleece", category: "Boys", retailer: "Next", price: 20.00, type: "top" },
  { id: "next-pumpkin-booties", name: "Neutral Pumpkin Baby Sock Top Boot Shoes", category: "Baby", retailer: "Next", price: 9.00, type: "foot" },
  // --- Girls · Next · added 7 Sep ---
  { id: "koko-pumpkin-sweatshirt", name: "Koko Blossom Cream Cutest Halloween Pumpkin Patch Sweatshirt", category: "Girls", retailer: "Next", price: 24.00, type: "top" },
  { id: "next-pumpkin-pie-cardigan", name: "Orange Pumpkin Pie V-Neck Cardigan", category: "Girls", retailer: "Next", price: 18.00, type: "top" },
  { id: "next-spot-barrel-jeans", name: "Blue Spot Pull-On Barrel Jeans", category: "Girls", retailer: "Next", price: 13.00, type: "bottom" },
  { id: "next-white-hightops", name: "White Canvas Lace Up High Top Trainers", category: "Girls", retailer: "Next", price: 22.00, type: "foot" },
];
